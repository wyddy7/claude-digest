...
CHAT_CLEARED = "🧹 История диалога с ассистентом очищена. Начнём с чистого листа."
CHAT_LIMIT_HIT = (
...
ONBOARDING_WELCOME = (
    ...
    "Каждый день в 11:00 он собирает посты из выбранных каналов, "
...
ONBOARDING_PREVIEW_CLOSE = (
    "Вот так это выглядит каждый день в 11:00 (МСК) 📰\n\n"
...
ONBOARDING_PREVIEW_FAIL = (
    ...
    "Каналы уже сохранены — основной дайджест придёт в 11:00, "
...
DIGEST_DAILY_CAP = (
    "📰 На сегодня дайджест уже был — следующий придёт завтра по расписанию.\n"
    "Хочешь чаще? Это будет в расширенных тарифах позже."
)

# ── /in (admin-only power tool) ─────────────────────────────────────────────────
IN_ADMIN_ONLY = "Эта команда сейчас доступна только администратору."
...
# Shown above the price lines when a crossed-out anchor is present.
SUB_BUY_DISCOUNT = "🔥 <b>Сейчас скидка</b> — забирай по сниженной цене:\n\n"
SUB_BUY_WALLET_TIP = (
