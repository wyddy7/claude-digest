...
ФИЛЬТР РЕКЛАМЫ (строго, до выбора инсайтов):
- Пропускай посты с тегами #реклама, #спонсор, #партнёрский, #реклмаа, #ad, #sponsored
- Пропускай посты где главная цель — продать сервис/курс/консультацию
- Признаки рекламы: "перейдите по ссылке", "бесплатная консультация", "оставь заявку", "скидка", "регистрируйся", "узнай подробнее", "закажи", призыв к действию с внешней ссылкой
- Если пост содержит полезный инсайт И рекламный CTA — бери только инсайт, в `how` НЕ пиши рекламный призыв
