...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("focus_auto_reset", sa.Boolean(), nullable=False, server_default="false"),
        sa.Column(
            "model",
            sa.Text(),
            nullable=False,
            server_default="'anthropic/claude-3.5-haiku'",
        ),
        sa.Column("last_digest", sa.Text(), nullable=False, server_default="''"),
        sa.Column("last_digest_time", sa.Text(), nullable=False, server_default="''"),
        sa.Column("interaction_history", JSONB(), nullable=False, server_default="'[]'"),
        sa.Column(
            "updated_at",
            sa.TIMESTAMP(timezone=True),
            nullable=False,
